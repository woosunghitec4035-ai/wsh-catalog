(function(){
const data={
 temperature:{title:'1채널 온도 자동제어',lead:'설정한 목표온도와 작동방식에 따라 한 채널의 개폐기를 자동 운전합니다.',visual:['현재온도 감지','목표온도 비교','열림·닫힘'],body:'WFVC는 한 채널 온도전용 컨트롤러입니다. 같은 채널에 연결된 개폐기들은 현재 적용되는 목표온도 조건에 따라 함께 작동합니다.'},
 variable:{title:'4단 변온관리',lead:'하루를 네 시간대로 나누어 각 단계마다 서로 다른 목표온도를 적용합니다.',visual:['1단 목표온도','2단 목표온도','3단 목표온도','4단 목표온도'],body:'각 단계마다 시작시각과 목표온도를 설정합니다. 다음 단계의 시작시각이 되면 해당 목표온도가 자동 적용됩니다. <b>4단은 네 개의 독립 채널이 아니라 한 채널의 목표온도를 시간대별로 네 번 바꾸는 기능</b>입니다.'},
 rain:{title:'빗물감지 기능',lead:'선택 사양인 강우센서가 빗물을 감지하면 환기창을 닫는 특별작동을 수행합니다.',visual:['강우센서','빗물 감지','환기창 닫힘'],body:'강우센서를 적용한 상태에서 빗물이 감지되면 자동 온도제어보다 우선하여 닫힘 특별작동을 실행합니다. 감지부의 오염과 설치 상태를 정기적으로 확인하십시오.'},
 fnd:{title:'데이터 FND 표시',lead:'현재시각, 현재온도와 설정 데이터를 적색 FND로 확인합니다.',visual:['현재시각','현재온도','설정 데이터'],body:'표시창을 통해 현재 적용 중인 변온 단계와 온도 설정값을 확인할 수 있습니다. 설정기호와 데이터가 점멸할 때 변경 항목을 확인한 뒤 저장하십시오.'},
 ...
 alarm:{title:'고온비상 경보기능',lead:'시설온도가 설정한 고온경보 온도를 넘으면 경보와 열림작동을 실행합니다.',visual:['고온경보 설정','이상고온 감지','경보 + 열림'],body:'고온경보가 발생하면 연결된 경보기로 신호를 출력하고 작물 보호를 위해 개폐기를 열림 방향으로 특별작동합니다. 경보기는 선택 사양입니다.'},
 ...
 sleep:{title:'잠자기 기능',lead:'보호시간이 지나면 부품 보호를 위해 출력을 중단하고 대기합니다.',visual:['보호시간 경과','잠자기 상태','다음 설정 조건에 복귀'],body:'설정된 보호시간이 지나면 내부 출력을 멈추고 대기합니다. 이후 다음 온도 작동 조건이 되면 잠자기 상태가 해제되어 정상운전으로 돌아갑니다.'},
 step:{title:'스텝작동',lead:'작동과 대기를 반복하여 환기창을 단계적으로 이동합니다.',visual:['작동','대기','반복'],body:'온도제어에서는 표준 스텝작동 또는 고급 온도비례작동 중 현장 조건에 맞는 방식을 선택할 수 있습니다.'},
 central:{title:'중첩신호 출력',lead:'센트럴 컨트롤러와 연동할 수 있도록 제어 신호를 출력합니다.',visual:['WFVC 자체제어','중첩신호 출력','센트럴 연동'],body:'WFVC의 자체 온도제어와 함께 센트럴 컨트롤러 연동에 사용할 수 있는 신호 출력 기능입니다. 실제 연결은 적용 센트럴 모델과 배선 사양을 확인해야 합니다.'},
